...
export const addRoomGenerationJobToQueue = async (payload : RoomGenerationJob, correlationId: string) => {
    await roomGenerationQueue.add(ROOM_GENERATION_PAYLOAD, { payload, correlationId })
}   