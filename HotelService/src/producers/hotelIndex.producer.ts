...
export const HOTEL_UPDATE_PAYLOAD = "payload:hotel-update";
...
export async function updateHotelIndexInESJobToQueue(hotelId: number) {
  console.log(`Adding hotel update job to queue for hotel ID: ${hotelId}`);
  await HotelIndexQueue.add(HOTEL_UPDATE_PAYLOAD, hotelId);
}
